...
4. When building using an older version of Go, make sure your `go.mod` file supports that version. Otherwise it will silently use the latest compiler version.